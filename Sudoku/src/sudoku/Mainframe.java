...
public class Mainframe extends javax.swing.JFrame {
    ...
    public void iniciarSudoku(String dificuldade) {
        ...
        SudokuPanel sudokuPanel = new SudokuPanel(dificuldade, this);
    ...
    public void continuarSudoku(int idPartida, int pontuacao, String dificuldade, String gabarito, String jogoAtual, int segundos, boolean custom) {
        
        // Criar dinamicamente um novo painel do jogo
        SudokuPanel sudokuPanel = new SudokuPanel(idPartida, pontuacao, dificuldade, gabarito, jogoAtual, segundos, custom, this);
